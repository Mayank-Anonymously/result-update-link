								...
								<Row className='g-3 container'>
									<Col md={4}>
										<Form.Select
											...
											<option value='Minisdesawar SHARJAH'>Sharjah</option>
											<option value='Minisdesawar 4 MINAR'>4 Minar</option>
											<option value='Minisdesawar GURGAON'>Gurgaon</option>
											<option value='Minisdesawar KALYAN'>Kalyan</option>
											<option value='Minisdesawar FARIDABAD'>Faridabad</option>
											<option value='Minisdesawar DESAWAR'>Desawar</option>
											<option value='Minisdesawar GHAZIABAD'>Gaziabad</option>
											<option value='Minisdesawar GALI'>Gali</option>
										</Form.Select>
									</Col>
